...
function main() {
    ...
    if (!(!!canvas.getContext && canvas.getContext("2d"))) {
        document.getElementById("consoleMe").innerHTML = "Your browser doesn't support HTML5, please update to latest version";
    }
...
window.onerror = function(error, url, line) {
	document.getElementById("consoleMe").innerHTML += error;
	document.getElementById("consoleMe").innerHTML += line;
}
